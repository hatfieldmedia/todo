...
module.exports = async context => {
  ...
  // TODO get todo bot working

  // Do not trigger on merge commits
  const commit = await context.github.git.getCommit(context.repo({commit_sha: context.payload.head_commit.id, sha: context.payload.head_commit.id}))
